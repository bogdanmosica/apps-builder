    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Quest Board</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Level up by completing your daily quests! Earn XP, unlock
            achievements, and become the ultimate productivity hero.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          {isLoggedIn ? (
            <GamifiedTodo userName={userName} isPro={isPro} />
          ) : (
              ...
              <Card className="border-2 border-dashed border-gray-300 bg-gray-50/50">
                ...
                <CardContent className="text-center">
                  <p className="text-gray-600 mb-6 max-w-md mx-auto">
                    Your personal quests, XP progress, and achievements are
                    waiting for you. Sign in to continue your journey!
                  </p>
