...
export async function PATCH(
  ...
  try {
    ...
    if (propertyLocation !== undefined)
      updateData.propertyLocation = propertyLocation;
    if (propertySurface !== undefined)
      updateData.propertySurface = propertySurface
        ? parseInt(propertySurface)
        : null;
    if (propertyFloors !== undefined)
      updateData.propertyFloors = propertyFloors;
    if (propertyConstructionYear !== undefined)
      updateData.propertyConstructionYear = propertyConstructionYear
        ? parseInt(propertyConstructionYear)
        : null;
