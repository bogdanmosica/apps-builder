...
export default function PropertyTypesTable({
  ...
  const [propertyTypes, setPropertyTypes] =
    useState<PropertyType[]>(initialPropertyTypes);
    ...
    <div>
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-2">
                      <Button
                        ...
                        size="icon"
                        onClick={() =>
                          setEditDialogState({ open: true, propertyType })
                        }
                      >
                      ...
                      <Button
                        ...
                        size="icon"
                        onClick={() =>
                          setDeleteDialogState({ open: true, propertyType })
                        }
                      >
      ...
      <EditPropertyTypeDialog
        ...
        onOpenChange={(open: boolean) =>
          setEditDialogState({
            open,
            propertyType: open ? editDialogState.propertyType : null,
          })
        }
      ...
      <DeletePropertyTypeDialog
        ...
        onOpenChange={(open: boolean) =>
          setDeleteDialogState({
            open,
            propertyType: open ? deleteDialogState.propertyType : null,
          })
        }
