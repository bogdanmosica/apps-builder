...
export default function QuestionManagement() {
  ...
  const [categoriesData, setCategoriesData] =
    useState<PropertyTypeWithCategories | null>(null);
  ...
  const [addPropertyTypeDialogOpen, setAddPropertyTypeDialogOpen] =
    useState(false);
  ...
  const loadCategoriesForPropertyType = async (propertyTypeId: number) => {
    ...
    try {
      const response = await fetch(
        `/api/admin/property-types/${propertyTypeId}?include=categories,questions,answers`,
      );
  ...
  const handleExportData = async () => {
    try {
      const queryParams = selectedPropertyType
        ? `?type=export&propertyTypeId=${selectedPropertyType}`
        : "?type=export";
  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent>
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button onClick={handleAddPropertyType} variant="outline">
      ...
      {!loading &&
        categoriesData &&
        categoriesData.questionCategories.length === 0 && (
          <Card>
            <CardContent className="p-6">
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-4">
                  Get started by adding the first category for this property
                  type.
                </p>
                  ...
                  <AccordionTrigger className="px-6 py-4 hover:no-underline">
                    <div className="flex items-center justify-between w-full mr-4">
                      ...
                      <Badge variant="secondary">
                        {category.questions?.length || 0} question
                        {(category.questions?.length || 0) !== 1 ? "s" : ""}
                      </Badge>
                    </div>
                  </AccordionTrigger>
                  <AccordionContent>
      ...
      <AddCategoryDialog
        ...
        propertyTypeId={
          selectedPropertyType ? parseInt(selectedPropertyType) : 0
        }
      ...
      <BulkImportDialog
        ...
        propertyTypeId={
          selectedPropertyType ? parseInt(selectedPropertyType) : undefined
        }
        propertyTypeName={
          selectedPropertyType
            ? propertyTypes.find(
                (pt) => pt.id.toString() === selectedPropertyType,
              )?.name_ro
            : undefined
        }
      />
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete this question? This will also
              delete all associated answers. This action cannot be undone.
              {questionToDelete && (
