import { pgTable, foreignKey, unique, serial, integer, varchar, text, timestamp, json, numeric, boolean } from "drizzle-orm/pg-core"
...
export const communicationStats = pgTable("communication_stats", {
	...
	satisfactionRate: numeric("satisfaction_rate", { precision: 5, scale:  2 }).default('0.00'),
...
export const integrations = pgTable("integrations", {
	...
	dataFlow: varchar("data_flow", { length: 20 }).default('bidirectional').notNull(),
	config: json().default({}),
...
export const campaigns = pgTable("campaigns", {
	...
	clickRate: numeric("click_rate", { precision: 5, scale:  2 }).default('0.00'),
...
export const conversations = pgTable("conversations", {
	...
	status: varchar({ length: 20 }).default('active').notNull(),
	participantStatus: varchar("participant_status", { length: 20 }).default('offline').notNull(),
