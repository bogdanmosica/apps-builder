...
export const propertyEvaluations = pgTable("property_evaluations", {
  ...
  questionId: integer("question_id")
    .notNull()
    .references(() => evaluationQuestions.id, { onDelete: "cascade" }),
  answerChoiceId: integer("answer_choice_id").references(
    () => evaluationAnswerChoices.id,
    { onDelete: "set null" },
  ),
...
export const propertyInquiriesRelations = relations(
  propertyInquiries,
  ({ one }) => ({
    property: one(properties, {
...
export const propertyFavoritesRelations = relations(
  propertyFavorites,
  ({ one }) => ({
    user: one(users, {
...
export const evaluationQuestionsRelations = relations(
  evaluationQuestions,
  ({ many }) => ({
...
export const evaluationAnswerChoicesRelations = relations(
...
export const propertyEvaluationsRelations = relations(
  propertyEvaluations,
  ({ one }) => ({
    property: one(properties, {
...
export const propertyQualityScoresRelations = relations(
...
export type EvaluationAnswerChoice =
  typeof evaluationAnswerChoices.$inferSelect;
export type NewEvaluationAnswerChoice =
  typeof evaluationAnswerChoices.$inferInsert;
