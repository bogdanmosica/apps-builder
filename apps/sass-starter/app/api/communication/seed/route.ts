  ...
  try {
    ...
    const sampleTemplates = [
      ...
      },
      {
        ...
        category: "support",
        content:
          "Hi {{name}}, thank you for contacting support. We have received your request and will respond within 24 hours.",
        usageCount: 432,
        createdBy: user.id,
      },
      {
        ...
        category: "product",
        content:
          "New feature available: {{feature_name}}. Check it out in your dashboard!",
        usageCount: 87,
        createdBy: user.id,
      },
    ];
