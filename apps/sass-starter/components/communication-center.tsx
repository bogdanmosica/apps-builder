        ...
        <div className="p-4 pb-2">
          <div className="flex items-center justify-between mb-3">
            ...
            {change && (
              ...
              >
                <TrendingUp
                  className={`h-3 w-3 mr-1 ${change.startsWith("-") ? "rotate-180" : ""}`}
                />
                {change}
              </div>
            )}
...
function ConversationRow({
  ...
  return (
    <TableRow
      className={`${conversation.unread > 0 ? "bg-blue-50" : ""} ${isArchived ? "bg-gray-50 opacity-75" : ""}`}
    >
      <TableCell>
      ...
      <TableCell>
        <Badge className={typeColors[conversation.type]}>
          {conversation.type}
        </Badge>
      </TableCell>
      <TableCell>
...
function ComposeMessageDialog() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success(
        `Message sent successfully!${result.messageId ? ` (ID: ${result.messageId})` : ""}`,
      );
    } catch (error) {
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    setSettings({ ...settings, autoReply: !settings.autoReply })
                  }
                >
              ...
              <div className="flex items-center justify-between">
                ...
                <Button
                  variant={
                    settings.desktopNotifications ? "default" : "outline"
                  }
                  size="sm"
                  onClick={() =>
                    setSettings({
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      responseTimeTarget: e.target.value,
                    })
                  }
                />
              </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) =>
                setReplyData({ ...replyData, priority: value as any })
              }
            >
              <SelectTrigger>
                <SelectValue />
...
function CallDialog({
  ...
  const startCall = () => {
    ...
    toast.success(
      `${type === "voice" ? "Voice" : "Video"} call initiated to ${conversation.participant}`,
    );
...
function ForwardDialog({
  ...
  const handleForward = async () => {
    ...
    const emailList = forwardData.recipients
      .split(",")
    ...
    try {
      ...
      onOpenChange(false);
      toast.success(
        `Conversation forwarded to ${emailList.length} recipient(s)`,
      );
    } catch (error) {
      ...
      toast.error(
        error instanceof Error
          ? error.message
          : "Failed to forward conversation",
      );
    } finally {
      setIsSubmitting(false);
    }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Forward the conversation with {conversation.participant} to other
            recipients
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                setForwardData({ ...forwardData, recipients: e.target.value })
              }
            />
          ...
          <div>
            ...
            <Textarea
              ...
              onChange={(e) =>
                setForwardData({ ...forwardData, addNote: e.target.value })
              }
            />
          </div>
        </div>
...
export default function CommunicationCenter() {
  ...
  const [viewFilter, setViewFilter] = useState<"current" | "archived">(
    "current",
  );
  ...
  const fetchConversations = async (
    ...
    try {
      ...
      const response = await fetch(
        `/api/communication/conversations?status=${status}`,
      );
      if (response.ok) {
  ...
  const currentConversations = conversations.filter((conversation: any) => {
    const matchesFilter =
      conversationFilter === "all" || conversation.type === conversationFilter;
    const matchesSearch =
      searchQuery === "" ||
      conversation.participant
        .toLowerCase()
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Real-time insights from your communication data
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 lg:gap-6">
              {statsConfig.map((statConfig) => {
                const IconComponent =
                  iconMap[statConfig.icon as keyof typeof iconMap] ||
                  MessageSquare;
                return (
                  <StatCard
                    key={statConfig.id}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="flex items-center bg-gray-100 rounded-lg p-1">
                      ...
                      <Button
                        variant={
                          viewFilter === "archived" ? "default" : "ghost"
                        }
                        size="sm"
                      ...
                      {conversationsLoading ? (
                        ...
                        displayedConversations.map((conversation) => (
                          <ConversationRow
                            ...
                            conversation={conversation}
                            onReply={() =>
                              console.log("Reply handled by internal dialog")
                            }
                            onArchive={() =>
